                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-4xl font-bold text-gray-900">
                      Welcome to
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800"> Airbnb Clone</span>
                    </h1>
                  </div>
                </div>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Discover amazing places to stay around the world. Book unique accommodations and create unforgettable memories.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">All accommodations are verified for quality and safety</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We guarantee the best prices for your bookings</p>
                  </div>
                </div>
              </div>
            </div>
