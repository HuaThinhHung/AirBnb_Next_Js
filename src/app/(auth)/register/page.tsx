            ...
            <div className="hidden lg:block space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Create your account and start exploring amazing places to stay. Join thousands of travelers who trust our platform.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Join Thousands of Users</h3>
                    <p className="text-gray-600">Be part of our growing community of travelers</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get started in minutes with our simple signup process</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`bg-white/70 border-2 border-gray-200 text-gray-900 text-base rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full pl-12 pr-4 py-4 transition-all duration-200 ${
                          errors.name ? 'border-red-400 focus:ring-red-500 focus:border-red-500' : 'hover:border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`bg-white/70 border-2 border-gray-200 text-gray-900 text-base rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full pl-12 pr-4 py-4 transition-all duration-200 ${
                          errors.email ? 'border-red-400 focus:ring-red-500 focus:border-red-500' : 'hover:border-gray-300'
                        }`}
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`bg-white/70 border-2 border-gray-200 text-gray-900 text-base rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full pl-12 pr-12 py-4 transition-all duration-200 ${
                          errors.password ? 'border-red-400 focus:ring-red-500 focus:border-red-500' : 'hover:border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`bg-white/70 border-2 border-gray-200 text-gray-900 text-base rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full pl-12 pr-12 py-4 transition-all duration-200 ${
                          errors.confirmPassword ? 'border-red-400 focus:ring-red-500 focus:border-red-500' : 'hover:border-gray-300'
                        }`}
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="terms" className="font-medium text-gray-700 leading-relaxed">
                        I agree to the{' '}
