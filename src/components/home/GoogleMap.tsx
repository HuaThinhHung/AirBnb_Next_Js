...
export default function GoogleMap() {
  const locations = [
    ...
    { lat: 40.7505, lng: -73.9934, title: 'Empire State Building' },
  ]

  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* --- giữ nguyên phần tiêu đề Our Locations --- */}
        {/* Location Info */}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">New York City</h4>
                    <p className="text-sm text-gray-600">50+ properties available</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">30+ properties available</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">40+ properties available</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">Miami</h4>
                    <p className="text-sm text-gray-600">25+ properties available</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">info@airbnbclone.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
